...
const Question = () => {
  ...
  const problemTitles = ["Balanced Parentheses", "Odd or Even"]; // Add problem titles
  ...
  return (
    <>
      {/* Pass the current problem title to the Navbar */}
      <Navbar
        language="Python"
        onLanguageChange={() => {}}
        streakCount={1}
        problemTitle={problemTitles[currentIndex]} // Pass the title here
      />
      
      <div
        className="relative drop-shadow-lg p-4 md:w-[450px] md:h-[505px] overflow-hidden rounded-xl bg-gradient-to-r from-[#2b2e33] to-[#1c1e22] flex items-center justify-center font-inter"
            ...
            <div className="flex justify-between mb-4 items-center">
              <div
                className={`text-white text-xs md:text-sm text-center py-1 px-3 rounded-full ${
                  timers[currentIndex] < 10
                    ? "bg-red-600"
                    : "bg-blue-600 bg-opacity-80 shadow-sm"
                }`}
              >
