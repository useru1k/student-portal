...
import { AlignLeft, X, ChevronDown, LogOut, User, Settings } from 'lucide-react';
import { useNavigate } from 'react-router-dom';

const A_TopNav = ({ isSideNavOpen, toggleSideNav, adminName = 'Karthiban R', adminID = 'ADM001' }) => {
    ...
    <nav className="topnav-bar">
      <style>{`
        ...
        @media (max-width: 500px) {
          ...
          .topnav-admin-badge { display: none; }
      ...
      <div className="topnav-left">
        ...
        <a href="/adashboard" className="topnav-brand">
          <div className="topnav-brand-icon">🛡️</div>
          <span className="topnav-brand-text">SIET LMS</span>
        </a>

        <span className="topnav-admin-badge">Admin</span>
        ...
        <div className="topnav-user-wrap" ref={dropdownRef}>
          ...
          >
            ...
            <div className="topnav-user-info">
              <span className="topnav-user-name">{adminName}</span>
              <span className="topnav-user-id">{adminID}</span>
            </div>
          ...
          {isDropdownOpen && (
            <div className="topnav-dropdown" role="menu">
              <div className="topnav-dropdown-header">
                <div className="topnav-dropdown-name">{adminName}</div>
                <div className="topnav-dropdown-id">{adminID}</div>
              </div>
              <a
                href="/adashboard/aprofile"
